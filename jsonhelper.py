def remove_comments(s):
    """
    Removes comments from a JSON string. Used to allow comments to be passed simplejson

    Credit goes to https://github.com/WizKid
    Source: https://gist.github.com/WizKid/1170297
    """
