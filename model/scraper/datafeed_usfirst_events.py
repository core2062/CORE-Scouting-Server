...
class DatafeedUsfirstEvents(object):
	...
	def getSessionKey(self, year=2012):
		...
		result = urllib2.urlopen(self.SESSION_KEY_GENERATING_PATTERN % year, timeout=60)
	...
	def getEventList(self, year):
		...
		"""
		result = urllib2.urlopen(self.REGIONAL_EVENTS_URL % year)
		if result.status_code == 200:
...
eventGetter = DatafeedUsfirstEvents()
print eventGetter
